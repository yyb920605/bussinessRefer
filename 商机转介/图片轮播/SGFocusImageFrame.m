...
- (void)setupViews
{
    ...
    */
    ...
    for (int i = 0; i < imageItems.count; i++) {
        ...
        //[imageView setTitle:@"cece" forState:UIControlStateNormal];
        //[imageView setImage:item.image forState:UIControlStateNormal];
...
-(void)clickPageImage:(UIButton *)sender{
    [self.delegate didSelect:(long)sender.tag];
}
